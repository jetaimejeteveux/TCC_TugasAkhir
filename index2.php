...
$result = mysqli_query($mysqli2, "SELECT * FROM user ORDER BY id DESC");
        ...
        <div class="col-md-6 offset-md-3">
            <table class='table table-striped'>
                ...
                while ($user_data = mysqli_fetch_array($result)) {
                    ...
                    echo "<td class='text-center'> <a class='btn btn-danger' href='delete2.php?id=$user_data[id]'>Delete</a></td></tr>";
                }
                ?>
            </table>
        </div>
